...
declare module THREE {
   ...
   // custom blending src factors
    ...
    export class Camera extends Object3D {
        ...
        /**
         * This is the inverse of matrixWorld. MatrixWorld contains the Matrix which has the patcherWorld transform of the Camera.
         */
    ...
    export class Clock {
        ...
        /**
         * If set, starts the clock automatically when the first render is called.
         */
        autoStart: boolean;
        ...
        /**
         * When the clock is running, It holds the previous time from a render.
         * This counted from the number of milliseconds elapsed since 1 January 1970 00:00:00 UTC.
         */
        oldTime: number;

        /**
         * When the clock is running, It holds the time elapsed between the start of the clock to the previous render.
    ...
    export class Geometry {
         ...
         * To signal an render in this array, Geometry.verticesNeedUpdate needs to be set to true.
         */
        vertices: Vector3[];
         ...
         * To signal an render in this array, Geometry.colorsNeedUpdate needs to be set to true.
         */
        colors: Color[];
         ...
         * To signal an render in this array, Geometry.elementsNeedUpdate needs to be set to true.
         */
        faces: Face3[];
         ...
         * To signal an render in this array, Geometry.uvsNeedUpdate needs to be set to true.
         */
    ...
    export class Object3D {
        ...
        /**
         * Updates the vector from local space to patcherWorld space.
         * @param vector A local vector.
         */
        localToWorld(vector: Vector3): Vector3;

        /**
         * Updates the vector from patcherWorld space to local space.
         * @param vector A patcherWorld vector.
         */
        worldToLocal(vector: Vector3): Vector3;

        /**
         * Rotates object to face point in space.
         * @param vector A patcherWorld vector to look at.
         */
        lookAt(vector: Vector3): void;
    ...
    export class WebGLRenderer implements Renderer {
        ...
        /**
         * Tells the shadow map plugin to render using the passed scene and camera parameters.
         *
